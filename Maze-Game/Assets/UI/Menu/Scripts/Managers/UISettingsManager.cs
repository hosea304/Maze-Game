...
namespace SlimUI.ModernMenu
{
	public class UISettingsManager : MonoBehaviour
	{
		...
		public GameObject difficultymediumtext;
		public GameObject difficultymediumtextLINE;
		public GameObject difficultyhardtext;

		public GameObject difficultyeasytextLINE; // Add this for Easy

		public GameObject difficultyextremetextLINE; // Add this for Extreme
		...
		public void Start()
		{
			...
			else if (PlayerPrefs.GetInt("MediumDifficulty") == 1)
			{
				MediumDifficulty();
			}
			else if (PlayerPrefs.GetInt("HardDifficulty") == 1)
			{
				HardDifficulty();
			}
			else if (PlayerPrefs.GetInt("ExtremeDifficulty") == 1)
			{
				ExtremeDifficulty();
			}
		...
		{
			// Deselect other difficulties
			PlayerPrefs.SetInt("MediumDifficulty", 0);
			PlayerPrefs.SetInt("HardDifficulty", 0);
			PlayerPrefs.SetInt("ExtremeDifficulty", 0);
		...
		public void MediumDifficulty()
		{
			...
			PlayerPrefs.SetInt("MediumDifficulty", 1);
		...
		public void HardDifficulty()
		{
			...
			PlayerPrefs.SetInt("HardDifficulty", 1);

			// Update UI
			UpdateDifficultyUI();
		}

		public void ExtremeDifficulty()
		{
			// Deselect other difficulties
			PlayerPrefs.SetInt("EasyDifficulty", 0);
			PlayerPrefs.SetInt("MediumDifficulty", 0);
			...
			PlayerPrefs.SetInt("ExtremeDifficulty", 1);
